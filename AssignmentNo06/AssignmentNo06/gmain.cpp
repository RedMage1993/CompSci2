...
//  Declare some students.
	...
	underGrad bouvier1;
	underGrad meyers("Meyers", "Roger", "L000134341", "", 3.41, 1300.75, 350.0, "Bien", GOOD);
	underGrad monroe;
	underGrad wiggum("Wiggum", "Clancy");
	underGrad ziff("Ziff", "Artie", "L001201101", "CS", 4.0, 9500.5, 2000.0);

	grad burns("Burns", "Charles", "L000017254", "UND", 1.0, 10000.0, 10000.0, "Smatresk", PROBATION);
	grad quimby("Quimby", "Joe", "L000127318", "POS", 1.77, 7120.5, 800.0, "Gewali", PROBATION);
	grad hibbert("Hibbert", "Julius", "L000087346", "PBH", 3.7, 1112.5, 1000.0, "Lee", GOOD);
	grad chalmers("Chalmers", "Gary", "L000001254", "HOA", 2.1, 1000.0, 500.0, "Lee", GOOD);
	grad krabappel("Krabappel", "Edna", "L000021231", "WOM", 2.15, 1500.0, 1000.00);
	grad riviera("Riviera", "Nick", "L000000666", "NUC", 1.0, 9200.25, 1500.00);
